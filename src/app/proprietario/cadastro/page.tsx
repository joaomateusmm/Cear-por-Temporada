                ...
                <div className="space-y-4">
                  <Form {...loginForm}>
                    ...
                    >
                      ...
                      <Button
                        type="submit"
                        className="text-md mt-6 w-full rounded-full bg-blue-500 py-6 font-bold text-slate-100 shadow-lg transition-all duration-300 hover:scale-[1.02] hover:bg-blue-600 hover:shadow-xl"
                        disabled={isLoginLoading}
                      >
                        {isLoginLoading ? (
                          <>
