      ...
      >
        <div className="mx-4 flex h-16 items-center justify-between md:mx-60">
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="text-xl font-bold text-[#101828] transition-colors hover:text-gray-200 md:text-2xl"
            >
              Logo
            </Link>
          </div>
      ...
      >
        <div className="mx-4 flex h-16 items-center justify-between md:mx-60">
          ...
          >
            <Link
              href="/"
              className="text-xl font-bold text-white transition-colors hover:text-gray-200 md:text-2xl"
            >
              Logo
            </Link>
          </div>
