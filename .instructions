...
com profundo conhecimento em TypeScript, React 19, Next.js 15 (App Router), Postgres, Drizzle,
...
- Sempre que for necessário interagir com o banco de dados, use o Drizzle ORM.
